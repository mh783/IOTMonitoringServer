...
ALLOWED_HOSTS = ["localhost", "18.206.145.220"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "34.207.192.181",  # Dirección IP de la base de datos
...
TOPIC = "colombia/cundinamarca/bogota/stark/out"
